...
class CTA_Evaluator:
  ...
  def _evaluate(self, client_payload, _context={}):
    ...
    false_cols, correct_cols, annotated_cols = set(), set(), set() # 错误注释的单元格，正确注释的单元格，注释的单元格
    TP = 0
    valid_annotations = 0
    ...
    print(len(false_cols), len(correct_cols), len(annotated_cols)) 
...
if __name__ == "__main__":
    ...
    answer_file_path = "../../CTACEA_g/ToughTablesR2-DBP/DataSets/ToughTablesR2-DBP/Valid/gt/cta_gt.csv"
    d = '../../CTACEA_g/ToughTablesR2-DBP/test_result/cta'
